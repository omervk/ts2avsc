...
export function toAvroIdl(sourceFile: ts.SourceFile): string {
    const protocol: ProtocolDeclaration = traverseSourceFile(sourceFile);
    return `// Autogenerated from ${sourceFile.fileName}.` + write(protocol);
    ...
    function traverseSourceFile(node: ts.Node): ProtocolDeclaration {
